  ...
  public static void populateTestSet(MemoryApi api, String userId,
    ...
    addMemory(api, userId, 2015, 5, 5,
        "It is possible I already had some presentiment of my future. " +
            "The locked and rusted gate that stood before us, with wisps of " +
            "river fog threading its spikes like the mountain paths, remains in " +
            "my mind now as the symbol of my exile. That is why I have begun this" +
