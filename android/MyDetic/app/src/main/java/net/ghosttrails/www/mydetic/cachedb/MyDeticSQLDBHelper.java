...
public class MyDeticSQLDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.i(TAG, String.format("SQL onCreate [%s]",
                MyDeticSQLDBContract.SQL_CREATE_MEMORY_DATES));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        Log.i(TAG, String.format("SQL onUpgrade [%s]",
                MyDeticSQLDBContract.SQL_DELETE_MEMORY_DATES));
